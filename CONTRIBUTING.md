...
Third-party patches are essential for keeping this repo great. We simply can't
...
Core, reducing its surface area, and to allow greater freedom for
module maintainers to ship releases at their own cadence, rather than
being held to the cadence of releases. With 4's "all in one"
...
module or part of Core, you may visit , or ask on
the for advice.
...
* For details on how to run tests, please see.
